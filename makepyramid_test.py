...
def pyramid (mc, x, y, z):
	...
	mc.setBlocks(x+5, y+5, z+5, x+5, y+5, z+5, coal)
	sleep (1)
	mc.setBlock(x+5, y+5,z+5, diamond)
	sleep (1)
...
def antenna (mc, x, y, z):
	gold =          41
	iron =           42
	for k in range(0,51):
		if k % 2 == 0:
			mc.setBlock(x, y+k, z, iron)
			sleep(0.2)
		else:
			mc.setBlock(x, y+k, z, gold)
			sleep(0.2)
...
pyramid(mc, x,y,z+5)
antenna(mc,x,y,z+5)
antenna(mc,x+5,y,z+5)
antenna(mc,x+5,y,z+10)
